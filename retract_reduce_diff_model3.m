function [Im_new, Cs_new, C_new, Is_new, I_new, Rs_new, R_new] = retract_reduce_diff_model3(Im, Cs, C, Is, I, Rs, R, F, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A)
