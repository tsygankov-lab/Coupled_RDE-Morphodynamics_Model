...
for j = 1:numt
    ...
    %protrude-retract
    if mod(j, mov_T) == 0
        [Im, Ps, P, Is, I, Cs, C, Rs, R] = protrude_extrapolate_diff_model5(Im, Ps, P, Is, I, Cs, C, Rs, R, F4, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A);
        [Im, Ps, P, Is, I, Cs, C, Rs, R] = retract_reduce_diff_model5(Im, Ps, P, Is, I, Cs, C, Rs, R, F4, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A);
