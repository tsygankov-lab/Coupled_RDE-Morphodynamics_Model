...
for j = 1:numt
    ...
    if mod(j, mov_T) == 0
        ...
        [Im, As, A, Cs, C] = protrude_extrapolate_diff_model2(Im, As, A, Cs, C, F1, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A);
        [Im, As, A, Cs, C] = retract_reduce_diff_model2(Im, As, A, Cs, C, F1, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A);
