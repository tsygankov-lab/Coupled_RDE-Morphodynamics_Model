...
for j = 1:numt
    ...
    %protrude-retract
    if mod(j, mov_T) == 0
        [Im, Cs, C, Is, I, Rs, R] = protrude_extrapolate_diff(Im, Cs, C, Is, I, Rs, R, F3, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A);
        [Im, Cs, C, Is, I, Rs, R] = retract_reduce_diff(Im, Cs, C, Is, I, Rs, R, F3, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A);
