...
for j = 1:numt
    ...
    %protrude-retract
    if mod(j, mov_T) == 0
        [Im, Rs, R, Is, I, Cs, C] = protrude_extrapolate_diff_model4(Im, Rs, R, Is, I, Cs, C, F1, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A);
        [Im, Rs, R, Is, I, Cs, C] = retract_reduce_diff_model4(Im_rb, Im, Rs, R, Is, I, Cs, C, F1, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A);
