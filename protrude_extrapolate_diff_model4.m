function [Im_new, Rs_new, R_new, Is_new, I_new, Cs_new, C_new] = protrude_extrapolate_diff_model4(Im, Rs, R, Is, I, Cs, C, F, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A)
