function [Im_new, Ps_new, P_new, Is_new, I_new, Cs_new, C_new, Rs_new, R_new] = retract_reduce_diff_model6(Im, Ps, P, Is, I, Cs, C, Rs, R, F, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A)
