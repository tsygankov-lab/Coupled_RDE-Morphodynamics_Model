...
A_act = 0.3; %parameter for the actin factor in the model of moving cell ("default" value of A starting from which cell begins to protrude)
...
save_fold = 'E:\Asef_Cdc42_Rac1_model\PIP_regulator_Cdc42_Rac1_coupled\2D_dynamic_model_differentiator';
subfold = strcat('A_act_', num2str(A_act), '_gamma_A_', num2str(gamma_A),  ...
    'gamma5_', num2str(gamma5), '_alpha5_', num2str(alpha5), ...
    '_mu5_', num2str(mu5), '_gamma7_', num2str(gamma7), ...
    '_alpha7_', num2str(alpha7), '_mu7_', num2str(mu7));
...
save(fullfile(save_fold, 'parameters.mat'), ...
    ...
    'Cs_L', 'C_L', 'Rs_L', 'R_L', ...
    'k1', 'gamma1', 'K1_basal', 'K1_edge', 'K1', 'beta1', 'n1', 'k2', ...
    'k3', 'gamma3', 'n3', 'k4', 'k5', 'gamma5', 'alpha5', 'mu5', ...
    'K5_basal', 'K5_edge', 'K5', 'n5', 'k6', 'k7', 'gamma7', ...
    'alpha7', 'mu7', 'K7_basal', 'K7_edge', 'K7', 'n7', 'k8', ...
    'DPs', 'DP', 'DIs', 'DI', 'DCs', 'DC', 'DRs', 'DR', ...
    'alpha_V', 'V0', 'beta_V', 'gamma_V', 'alpha_A', 'A_act', 'beta_A', ...
    'gamma_A', 'g', 'k', 'sub_iter_N', 'mov_T', 'save_T', 'crop_d', ...
    'n_alf', 'Im', 'i_start', 'i_end', 'j_start', 'j_end', ...
...
for j = 1:numt
    ...
    %protrude-retract
    if mod(j, mov_T) == 0
        [Im, Ps, P, Is, I, Cs, C, Rs, R] = protrude_extrapolate_diff_model6(Im, Ps, P, Is, I, Cs, C, Rs, R, F4, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A);
        [Im, Ps, P, Is, I, Cs, C, Rs, R] = retract_reduce_diff_model6(Im, Ps, P, Is, I, Cs, C, Rs, R, F4, g, k, V0, alpha_V, beta_V, gamma_V, A_act, alpha_A, beta_A, gamma_A);
    ...
    for i = 1:sub_iter_N
        ...
        F3 = (k5 + (gamma5 + alpha5*Ps.^n5 + mu5*Rs.^n5).*Cs.^n5./(K5.^n5 + Cs.^n5)).*C - k6*Cs;
        F4 = (k7 + (gamma7 + alpha7*Ps.^n7 + mu7*Cs.^n7).*Rs.^n7./(K7.^n7 + Rs.^n7)).*R - k8*Rs;
